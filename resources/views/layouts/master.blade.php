...
<head>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/froala-editor/4.0.14/css/froala_style.min.css">
...
<body class="index-page">
  ...
  {{-- Start main --}}
  <main>
    @yield('content') <!-- Đây là nơi nội dung trang con sẽ hiển thị -->
  </main>
  {{-- End main --}}
