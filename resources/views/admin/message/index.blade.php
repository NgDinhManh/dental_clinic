                                ...
                                <tbody>
                                    @foreach ($messages as $message)
                                        <tr>
                                            ...
                                            <td> <a href="{{ route('admin/message/show', $message->message_id) }}"
                                                    class="text-primary">{{ $message->name }}</a></td>
                                            <td>
                                                {{ $message->subject }}
                                            </td>
                                            ...
                                            <td>
                                                <form action="{{ route('admin/message/destroy', $message->message_id) }}"
                                                    ...
                                                    id="delete-form-{{ $message->userid }}">
                                                    @csrf @method('delete')
                                                    <a class="btn btn-link btn-primary btn-lg"
                                                        href="{{ route('admin/message/reply', $message->message_id) }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-link btn-danger delete-button"
                                                        data-bs-toggle="modal" data-bs-target="#confirmDeleteModal"
                                                        data-form-id="delete-form-{{ $message->userid }}">
